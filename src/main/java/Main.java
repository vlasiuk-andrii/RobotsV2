public class Main {
    public static void main(String[] arg) {
        ...
        do{
            ...
            r1.charge -= 5; r1.wasCharged = false;
            r2.charge -= 5; r2.wasCharged = false;
            r3.charge -= 5; r3.wasCharged = false;
            r4.charge -= 5; r4.wasCharged = false;
            r5.charge -= 5; r5.wasCharged = false;
            r6.charge -= 5; r6.wasCharged = false;
        ...
        } while ((r1.charge > minCharge) && (r2.charge > minCharge) && (r3.charge > minCharge) && (r3.charge > minCharge) &&
                (r5.charge > minCharge) &&
                (r1.charge < maxCharge) && (r2.charge < maxCharge) && (r3.charge < maxCharge) && (r4.charge < maxCharge) &&
                (r5.charge < maxCharge));
